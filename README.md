# Painel Interativo de Avaliação de Desempenho
...
* **Pandas:** Limpa a base de dados, uni as tabelas, calcula as médias de cada competência e extrai a diferença exata entre as notas.
...
* **Streamlit e HTML/CSS:** Roda o front-end, aplica filtros interativos e hospeda a aplicação na nuvem.
